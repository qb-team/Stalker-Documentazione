...
\textbf{Modalità di tracciamento anonimo\ap{G} DA MODIFICARE}\\
...
\textbf{Modalità di tracciamento autenticato\ap{G}}\\
...
\textbf{Movimento\ap{G}}\\
Per movimento\ap{G} si intende una azione fisica di ingresso o di uscita nei luoghi dell'organizzazione\ap{G} che viene effettuata dall'utente. \\ \\
\clearpage