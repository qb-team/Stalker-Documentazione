...
\begin{itemize}
	...
	\item \textbf{Stalker-App-PoC}: Viene usato per versionare il codice sorgente relativo dell'applicazione mobile per lo sviluppo del \glo{PoC}. Verrà integrato nel repository \textit{Stalker};
