...
\paragraph{Git}
Nel processo di sviluppo è stato utilizzato Git, un software di controllo di versione distribuito che ha aiutato il gruppo \Gruppo}{\textit{qbteam} a tenere traccia di tutte le modifiche apportate ad un file facilitando la risoluzione di un eventuale problema dovuto a tali cambiamenti.
