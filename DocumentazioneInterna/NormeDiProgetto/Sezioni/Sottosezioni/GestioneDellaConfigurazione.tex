...
\subsubparagraph*{Versionamento per la documentazione}
\begin{itemize}
...
\subsubparagraph*{Versionamento per il prodotto software, per il manuale utente e per il manuale manutentore}
\begin{itemize}
	\item \textbf{X}: Detto indice major, rappresenta il numero di una versione stabile, quando X $> 0$.
