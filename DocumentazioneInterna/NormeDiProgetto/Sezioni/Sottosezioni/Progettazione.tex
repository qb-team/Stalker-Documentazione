...
\begin{itemize}
	...
	\item \textbf{Diagrammi di attività}: Utilizzati per rappresentare gli aspetti dinamici dei casi d'uso, mostrando l'esecuzione di un'attivitò;
...
\subsubparagraph*{Diagrammi delle classi}
Per tutte le regole standard di UML riguardanti i diagrammi delle classi, consultare il seguente link: \url{https://www.math.unipd.it/~tullio/IS-1/2019/Dispense/E01b.pdf}
\begin{itemize}
...
\subsubparagraph*{Diagrammi di sequenza}
Per tutte le regole standard di UML riguardanti i diagrammi di sequenza, consultare il seguente link: \url{https://www.math.unipd.it/~tullio/IS-1/2019/Dispense/E02a.pdf}


\subsubparagraph*{Diagrammi di attività}
Per tutte le regole standard di UML riguardanti i diagrammi di attività, consultare il seguente link: \url{https://www.math.unipd.it/~tullio/IS-1/2019/Dispense/E02b.pdf}

\subsubparagraph*{Diagrammi di package}
Per tutte le regole standard di UML riguardanti i diagrammi dei package, consultare il seguente link: \url{https://www.math.unipd.it/~tullio/IS-1/2019/Dispense/E01c.pdf}
\\
Per indicare un'interfaccia all'interno di un package si usa la keyword interface tra parentesi angolate, sopra al nome della classe.
Per indicare una classe astratta all'interno di un package si usa la keyword abstract tra parentesi graffe, sopra al nome della classe.
