...
\subparagraph*{Processo di miglioramento}
\begin{itemize}
...
\subparagraph*{Formazione dei membri del gruppo}
...
\subsubsection{Scopo}
Il processo di gestione di formazione ha lo scopo di:


\subsubsection{Aspettative}
Il processo di gestione di formazione cerca di soddisfare le seguenti aspettattive:


\subsubsection{Descrizione}
I temi riscontrati svolgendo le attività del processo di gestione di formazione sono:
