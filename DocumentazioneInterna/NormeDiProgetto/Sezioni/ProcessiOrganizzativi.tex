...
\subsubparagraph{Scopo}
Il processo di miglioramento garantisce tramite misurazioni e controlli regolari il miglioramento del processo di sviluppo del prodotto.

\subsubparagraph{Valutazione}
Durante lo sviluppo del prodotto l'attività di valutazione deve essere instanziata e documentata, la revisione della documentazione prodotta deve avvenire ad intervalli regolari per poter intervenire nel breve periodo.

\subsubparagraph{Miglioramento}
Il gruppo deve, se necessario, compiere dei cambiamenti ai processi come emerge dall'attività di valutazione; la documentazione cretata nella valutazione deve essere aggiornata in modo che rifletta i cambiamenti.\\
