...
\item Per la delivery mode\ap{G} sarà sufficiente l'accessibilità da almeno un sistema operativo tra:
\begin{itemize}
\item Linux;
\item Window;
\item OS X.
...
\item L'obiettivo finale del capitolato è prodotto per le aziende, il linguaggio utilizzato (gherkin) è di nicchia e la conversazione tra stakeholder e UML\ap{G} sono ancora lo standard.
\end{itemize}
