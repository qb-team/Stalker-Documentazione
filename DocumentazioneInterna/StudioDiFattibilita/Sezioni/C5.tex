...
\item Utilizzo del pattern di \glo{Publisher/Subscriber}, ovvero mittenti (Publisher) e destinatari (Subscriber) di messaggi dialogano attraverso un tramite(\glo{dispatcher});
