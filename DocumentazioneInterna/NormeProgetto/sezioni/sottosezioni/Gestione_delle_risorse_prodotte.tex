...
\begin{itemize}
	...
	\begin{itemize}
		\item \textbf{VerbaliEsterni/}: Dentro a questa cartella sono presenti i file sorgente in \LaTeX per la generazione dei verbali degli \glo{incontri formali} fra i membri del gruppo e il proponente del progetto;
	...
	\begin{itemize}
		\item \textbf{VerbaliInterni/}: Dentro a questa cartella sono presenti i file sorgente in \LaTeX per la generazione dei verbali degli \glo{incontri formali} fra i membri del gruppo.
		Per ogni incontro viene redatto un verbale che è presente in un'unica cartella;
