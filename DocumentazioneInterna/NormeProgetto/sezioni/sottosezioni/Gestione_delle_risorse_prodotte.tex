...
\item Per ogni \glo{commit} è opportuno commentare con chiarezza per capire cosa si è fatto in modo tale da garantire una buona \glo{organizzazione} e chiarezza nella struttura di versionamento.
\end{itemize}
