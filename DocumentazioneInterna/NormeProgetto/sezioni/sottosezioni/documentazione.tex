...
\begin{itemize}
    \item \textbf{VI_[YYYY]_[MM]_[DD].pdf}: contenente il verbale interno del [YYYY]-[MM]-[DD];
    \item \textbf{VE_[YYYY]_[MM]_[DD].pdf}: contenente il verbale esterno del [YYYY]-[MM]-[DD];
\end{itemize}
con:
\begin{itemize}
