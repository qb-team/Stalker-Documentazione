...
I nomi di file(escludendo l'estensione) e cartelle sono scritti usando la convenzione "\glo{CamelCase}". Inoltre il gruppo \Gruppo ha scelto di adottare delle regole aggiuntive, quali:
\begin{itemize}
