...
Per automatici si intende la necessità di disporre di un'automazione (per esempio un comando da \glo{CLI}) che permetta a tutti i membri del gruppo di invocare ed eseguire tutti (o in parte) i test.
...
con:
    ...
    \end{itemize}
    \item \textbf{[Numero progressivo:]} i numeri progressivi vengono incrementati per ogni test di sistema e sono calcolati separatamente in base alla destinazione. Il conteggio parte da 1.
    \begin{itemize}
