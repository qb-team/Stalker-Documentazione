...
\paragraph{Template di esempio per i diagrammi UML dei casi d'uso}\mbox{}\\ \\

\begin{figure}[h]
	\centering	
	\includegraphics[scale=0.4]{images/TemplateSchemaUseCase.png}
	\caption{UC[Destinazione] X.Y - Template del diagramma UML di un caso d'uso}
\end{figure}
