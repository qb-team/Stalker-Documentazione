...
\subsubsection{Scopo}
Lo scopo di questa sezione è quella di formalizzare delle norme e delle procedure al fine di diventare fornitori del proponente Imola Informatica e dei commitenti Prof. Tullio Vardenega e Prof. Riccardo Cardin 
...
\subparagraph{Codice idefinticativo dei casi d'uso}\mbox{}\\
...
L'ultimo caso d'uso kite-level sia lato applicazione che lato server conterrà, tutti i casi d'uso d'errore e di messaggi informativi di tutti i casi d'uso lato applicazione e lato server rispettivamente.
