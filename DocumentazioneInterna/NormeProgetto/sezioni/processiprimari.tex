...
\begin{itemize}
	\item \textbf{Analisi dei requisiti}: attività in cui si cerca di capire appieno il problema presentato dal cliente ricavando i requisiti\ap{G} da soddisfare nella realizzazione del prodotto;
...
\begin{itemize}
	...
	\begin{itemize}
		\item \textbf{X}, se il caso d'uso è di tipo kite-level\ap{G}.
		\item \textbf{X.Y}, se il caso d'uso è di tipo sea-level\ap{G}.
		\item \textbf{X.Y.Z}, se il caso d'uso è di tipo fish-level\ap{G}
	\end{itemize}
\end{itemize}
...
\subparagraph*{Struttura dei casi d'uso}\mbox{}\\
