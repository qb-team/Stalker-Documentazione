...
In aggiunta a \glo{Slack} per poter comunicare tramite chiamata viene utilizzato \glo{Discord}, un software che fornisce server gratis per gli utenti e infrastrutture per server dedicati.
All'interno di questa piattaforma, come con \glo{Slack}, sono stati creati dei \glo{canali} per poter discutere di diversi documenti in contemporanea senza disturbi.
I canali sono:
\begin{itemize}
	\item \textbf{analisi-dei-requisiti}: Come per \glo{Slack};
	\item \textbf{calendario}: Come per \glo{Slack};
	\item \textbf{documentazione-progetto}: Come per \glo{Slack};
	\item \textbf{general}: Come per \glo{Slack};
	\item \textbf{norme-di-progetto} Come per \glo{Slack};
    \item \textbf{piano-di-progetto} Come per \glo{Slack};
	\item \textbf{piano-di-qualifica} Come per \glo{Slack};
	\item \textbf{studio-di-fattibilita} Come per \glo{Slack};
	\item \textbf{verbali} Come per \glo{Slack};
	\item \textbf{source-code-management} Come per \glo{Slack};
	\item \textbf{\#solo-emergenze} L'unico canale testuale di \glo{Discord} in caso \glo{Slack} non sia disponibile.
\end{itemize}
...
Ha l'onere di rappresentante del gruppo presso l'azienda proponente.
