...
In aggiunta a \glo{Slack} per poter comunicare tramite chiamata viene utilizzato \glo{Discord}, un software che fornisce server gratuiti per gli utenti e infrastrutture per server dedicati.
