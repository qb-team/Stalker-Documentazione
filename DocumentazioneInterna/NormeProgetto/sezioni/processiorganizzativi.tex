...
In aggiunta a \glo{Slack} per poter comunicare tramite chiamata viene utilizzato \glo{Discord}, un software che permette di effettuare chiamte vocali tramite una connessione a Internet.
