...
\begin{itemize}
	...
	\item \textbf{Implementazione della Product Baseline}: Seguendo le specifiche della \glo{Technology Baseline}, viene realizzata una prima versione stabile del prodotto, \glo{baseline} utilizzata per il lavoro futuro;
	...
	L'obiettivo del gruppo in questa fase è di progettare gli incrementi con i requisiti obbligatori per poter soddisfare gli \glo{stakeholder};
	\item \textbf{Verifica}: \glo{Verifica} per assicurarsi della bontà dei requisiti implementati;
...
\end{itemize}
\paragraph{Incrementi con requisiti obbligatori}
\begin{itemize}
