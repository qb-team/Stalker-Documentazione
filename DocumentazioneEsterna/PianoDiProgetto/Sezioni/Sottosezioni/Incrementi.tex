...
Incremento 5 & Autenticazione presso l'organizzazione/Gestione amministratori (app utenti) e modifica dell'organizzazione (web-app admin) &
    % APP
    Nessun requisito dell'applicazione previsto per questo incremento.
    & \begin{itemize} 
    % WEB-APP ADMIN
...
Incremento 6 & Opz des & \begin{itemize}
    % APP
    \item[ ] R2FA5.1
    \item[ ] R2FA5.2
    \item[ ] R2FA5.3
...
Incremento 7 & Opz des & \begin{itemize}
    % APP
    \item[ ] R2FA1.8
    \item[ ] R2FA1.9
    \item[ ] R2FA1.10
...
Incremento 8 & Opz des & \begin{itemize}
    % APP
    \item[ ] R2FA3.11
    \item[ ] R2FA3.12
    \item[ ] R3FA3.13
