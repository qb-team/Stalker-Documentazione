...
La seguente tabella rappresenta la distribuzione oraria dei ruoli per ogni componente del gruppo.
	...
	\centering
	\begin{table}
	\caption{Tabella della divisione Orario di Analisi}
	
	\begin{tabular} { C{4cm} C{1cm} C{1cm} C{1cm} C{1cm} C{1cm} C{1cm} C{3cm}}
		\rowcolor{rossoep}
		\textcolor{white}{\textbf{Membro del gruppo}} & \textcolor{white}{\textbf{RE}} & \textcolor{white}{\textbf{AM}} & \textcolor{white}{\textbf{AN}} & \textcolor{white}{\textbf{PT}} & \textcolor{white}{\textbf{PR}} & \textcolor{white}{\textbf{VE}} & \textcolor{white}{\textbf{Ore complessive}}\\	
...
La seguente tabella rappresenta, per ruolo, le ore totali investite e il corrispondente costo in euro.
{
	...
	\centering
\begin{table}
	\caption{Tabella del costo Risultante Orario della Progettazione Architetturale}
	\begin{longtable}{ C{3cm} C{2cm} C{4cm}}
		\rowcolor{rossoep}
		\textcolor{white}{\textbf{Ruolo}} & \textcolor{white}{\textbf{Totale ore}} & \textcolor{white}{\textbf{Costo ruolo in euro}}\\	
...
La seguente tabella rappresenta, per ruolo, le ore totali investite e il corrispondente costo in euro.
{
	...
	\centering
\begin{table}
	\caption{Tabella della divisione oraria della Validazione e Collaudo}
	\begin{longtable}	{ C{3cm} C{2cm} C{4cm}}
		\rowcolor{rossoep}
		\textcolor{white}{\textbf{Ruolo}} & \textcolor{white}{\textbf{Totale ore}} & \textcolor{white}{\textbf{Costo ruolo in euro}}\\	
