...
La seguente tabella §5.1.2 rappresenta per ogni ruolo le ore totali investite e il corrispondente costo in euro.
{
	\rowcolors{2}{grigetto}{white}
	\renewcommand{\arraystretch}{2}
...
\subsubsection{Costo Risultate}
La seguente tabella §5.2.2 rappresenta per ogni ruolo le ore totali investite e il corrispondente costo in euro.
{
	\rowcolors{2}{grigetto}{white}
	\renewcommand{\arraystretch}{2}
	\begin{longtable}{ C{3cm} C{2cm} C{4cm}}
...
\subsubsection{Costo Risultate}
La seguente tabella §5.4.2 rappresenta per ogni ruolo le ore totali investite e il corrispondente costo in euro.
{
	\rowcolors{2}{grigetto}{white}
	\renewcommand{\arraystretch}{2}
	\begin{longtable}{ C{3cm} C{2cm} C{4cm}}
