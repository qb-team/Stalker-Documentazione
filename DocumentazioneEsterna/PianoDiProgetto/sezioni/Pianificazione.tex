...
Alla fine di ciascun periodo corrisponde una \glo{milestone} interna. A differenze delle \glo{milestone} relative alle \glo{fasi}, le cui date vengono stabilite dal calendario del committente, le \glo{milestone} interne sono scelte dal \Responsabile{} del gruppo \Gruppo{}.
...
\begin{itemize}
	...
	\item \textbf{Incrementi}: Per facilitare l'organizzazione del lavoro di progettazione e di implementazione, vengono indicati qui di seguito gli incrementi che vengono portati avanti (come indicato in §3.3):
		...
		\end{itemize}
		L'obiettivo è progettare almeno i requisiti obbligatori degli incrementi e avere un Proof of Concept che li sappia dimostrare correttamente, in modo da avere una solida baseline per le successive fasi;
