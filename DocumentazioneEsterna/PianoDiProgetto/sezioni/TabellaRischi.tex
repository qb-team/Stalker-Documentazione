...
RP1 Conflitti decisionali & Alcuni componenti del gruppo potrebbero essere in disaccordo su alcune decisione prese creando una situazione di malessere & Il componente del gruppo comunicherà la sua controversia per una conferma di una decisione  & Si cercherà di ascoltare e commentare tutte le opinioni di ciascun componente del team cercando di scegliere la soluzione più adatta per il bene del progetto \\ 
