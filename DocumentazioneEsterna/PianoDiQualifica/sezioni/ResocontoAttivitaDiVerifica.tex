...
In questo periodo di tempo il gruppo è stato molto impegnato nello sviluppo del $\glo{Proof$ $of$ $Concept}$, perciò è stato necessario adottarsi di strumenti per la stesura e la verifica statica del codice. 
...
\begin{axis}[
title=Grafico andamento dell'actual cost of work performed per ogni periodo,
x tick label style={
	/pgf/number format/1000 sep=},
ylabel=ACWP,
enlargelimits=0.05,
...
\begin{axis}[
title=Grafico andamento del budgeted cost of work scheduled per ogni periodo,
x tick label style={
	/pgf/number format/1000 sep=},
ylabel=BCWS,
enlargelimits=0.05,
...
\begin{axis}[
title=Grafico andamento del budgeted cost of work performed per ogni periodo,
x tick label style={
	/pgf/number format/1000 sep=},
ylabel=BCWP,
enlargelimits=0.05,
