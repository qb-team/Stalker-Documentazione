...
In questa sezione si vogliono elencare e tracciare i cambiamenti adottati dal gruppo a seguito di segnalazioni fatte dal proponente e dal committente. Vengono perciò riportati i problemi segnalati e le relative soluzioni. 
{
	...
	\begin{longtable}{ C{2cm} C{6cm} C{6cm}}
		...
		quella di leggere comprendendo. & Attuata una gestione migliore della sezione delle metriche di qualità cambiando la struttura delle sezione in modo tale da non riduce la coesione informativa.\\
		...
		\AdR & Fig. 4 un caso d’uso non può apparire nel suo proprio diagramma. & Modifica l'immagine in modo da essere coerente con la segnalazione.\\
		...
		\AdR & UCS6 l’estensione non è corretta & Nel UCS6 è stata tolta l'estensione errata.\\
