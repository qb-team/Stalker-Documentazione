...
Verificare\ap{G} che l'utente riconosciuto possa inserire la modalità di tracciamento\ap{G}:
\begin{enumerate}
    \item anonimo\ap{G}.
    \item autenticato\ap{G}.
\end{enumerate}
...
Verificare\ap{G} che:
\begin{enumerate}
    \item l'utente anonimo possa vedere il proprio storico accessi presso un'organizzazione\ap{G}. Ogni accesso deve mostrare la data in cui è stato compiuto, il luogo corrispondente, il tempo totale trascorso all'interno nel luogo;
    ...
    \item in assenza di accessi effettuati presso un'organizzazione\ap{G} l'utente anonimo visualizzi un messaggio informativo.
\end{enumerate}
...
Verificare\ap{G} che:
\begin{enumerate}
    \item che l'amministratore non autenticato\ap{G} che  possa inserire l'e-mail correttamente;
    \item che l'amministratore non autenticato\ap{G} possa inserire correttamente la password;
    \item che l'amministratore non autenticato\ap{G} visiona un messaggio d'errore se l'autenticazione\ap{G} viene negata per inserimento di credenziali errate.
\end{enumerate}
...
% R1FS2.1
TSF-X & Logout\ap{G} dell'amministratore autenticato\ap{G} & 
Verificare\ap{G} che:
\begin{enumerate}
    \item l'amministratore autenticato\ap{G} possa effettuare il logout\ap{G} dal server.
\end{enumerate} \\
...
Verificare\ap{G} che:
\begin{enumerate}
    \item l'amministratore gestore possa essere in grado di aggiungere un nuovo luogo in cui effettuare il tracciamento\ap{G};
    \item l'amministratore gestore possa essere in grado di modificare un luogo dell'organizzazione\ap{G};
    \item l'amministratore gestore possa essere in grado di eliminare un luogo dell'organizzazione\ap{G};
    \item venga negata la selezione di un'area che non rispetta i vincoli imposti per l'organizzazione\ap{G}, visionando un messaggio d'errore;
    \item venga negato l'inserimento di un luogo se viene selezionata un'area che fuoriesce dal perimetro imposto per l'organizzazione\ap{G}, visionando un messaggio d'errore.
\end{enumerate} \\
...
Verificare\ap{G} che:
\begin{enumerate}
    \item l'amministratore gestore possa selezionare l'area geografica in cui effettuare il tracciamento\ap{G}mediante l'inserimento di coordinate geografiche;
    \item l'amministratore gestore possa selezionare l'area geografica in cui effettuare il tracciamento\ap{G}mediante l'inserimento di marcatori su una mappa interattiva;
    \item l'amministratore gestore possa annullare l'operazione di modifica del luogo dell'organizzazione\ap{G}.
\end{enumerate} \\
