...
% R1FA2
TS-1FA2.1  & Logout\ap{G} dell'utente anonimo & \begin{enumerate}
...
TS-1FA4.1 & Selezione della modalità di tracciamento\ap{G} & 
...
TS-2FA5.1 & Storico degli accessi\ap{G} dell'utente anonimo presso un'organizzazione\ap{G} & 
...
TS-2FA5.2 & Storico degli accessi\ap{G} dell'utente anonimo presso un luogo di un'organizzazione\ap{G} & 
Verificare\ap{G} che:    
\begin{enumerate}
...
TS-2FA6.1 & Tracciamento\ap{G} dell'utente anonimo/riconosciuto nei luoghi di un'organizzazione\ap{G} &
...
TS-1FA7.1 & Autenticazione con credenziali LDAP\ap{G} &
Verificare che l'utente anonimo:
\begin{enumerate}
