...
TSS1 & Accesso all'interfaccia amministratore di un utente non autenticato & 
...
\end{enumerate}
Se l'organizzazione richiede il \glo{tracciamento autenticato}, verificare che l'amministratore visualizzatore:
\begin{enumerate}[resume]
