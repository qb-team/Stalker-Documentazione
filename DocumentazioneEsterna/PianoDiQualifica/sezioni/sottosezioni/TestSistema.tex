...
% R1FA2
TSA2  & \glo{Logout} dell'utente anonimo & \begin{enumerate}
...
TSA3 & Gestione lista delle \glo{organizzazioni} &
...
TSA6 & Selezione della modalità di \glo{tracciamento} & 
...
TSA7 & \glo{storico degli accessi} dell'utente anonimo presso un'\glo{organizzazione} & 
...
TSA8 & \glo{storico degli accessi} dell'utente anonimo presso un luogo di un'\glo{organizzazione} & 
\glo{Verificare} che:    
\begin{enumerate}
...
TSA9 & \glo{Tracciamento} dell'utente anonimo/riconosciuto nei luoghi di un'\glo{organizzazione} &
...
TSA10 & Autenticazione con credenziali \glo{LDAP} &
Verificare che l'utente anonimo:
\begin{enumerate}
