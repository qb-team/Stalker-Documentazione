...
TI & Si verifichi l’integrazione tra l’applicazione web e servizi di \glo{Firebase} permetta l’autenticazione a un amministratore. & NI \\
TI & Si verifichi l’integrazione tra l’applicazione web e servizi di \glo{Firebase} permetta il reset della password a un amministratore. & NI \\
TI & Si verifichi l’integrazione tra applicazione web sviluppata in Angular 2+ e \glo{Firebase}.& NI \\
TI & Si verifichi l’integrazione tra l’applicazione web e il server LDAP permetta l’autenticazione.& NI \\
TI & Si verifichi l’integrazione tra REST-API e \glo{backend} permetta la comunicazione fra loro.& NI \\
...
TI & Si verifichi l’integrazione tra l’applicazione web e REST-API permetta di visualizzare i dati relativi a un’organizzazione ricevuti dal \glo{backend}.& NI \\
TI & Si verifichi l’integrazione tra l’applicazione web e REST-API permetta di visualizzare i dati relativi a un luogo di un’organizzazione ricevuti dal \glo{backend}.& NI \\
TI & Si verifichi l’integrazione tra l’applicazione web e REST-API permetta di modificare i dati relativi a un’organizzazione e inviare le modifiche al \glo{backend}.& NI \\
TI & Si verifichi l’integrazione tra l’applicazione web e REST-API permetta di modificare i dati relativi a un luogo di un’organizzazione e inviare le modifiche al \glo{backend}.& NI \\
...
TI & Si verifichi l’integrazione tra l’applicazione web e REST-API permetta di inviare al \glo{backend} una richiesta di eliminazione di un’organizzazione.& NI \\
TI & Si verifichi l’integrazione tra l’applicazione web e REST-API permetta di eliminare un luogo dell’organizzazione.& NI \\
TI & Si verifichi l’integrazione tra l’applicazione web e REST-API permetta di modificare i permessi di un amministratore dell’organizzazione e salvare le modifiche nel \glo{backend}.& NI \\
