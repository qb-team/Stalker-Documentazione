...
\begin{itemize}
    \item Verifica che l'utente possa effetturare il reset della password qualora se la fosse dimenticata.
\end{itemize}
...
TSF-X & Tracciamento dell'utente nell'organizzazione & \begin{enumerate}
    \item Verificare che il tracciamento del muovimento dell'utente venga registrato correttamente.
    \item Verificare che l'utente abbia ricevuto la notifica della corretta registrazione del suo muovimento.
    \item Verificare che se le informazioni necessarie per la registrazione del muovimento non sono memorizzate, allora l'utente dovrà ricevere una notifica di tracciatura fallita.
\end{enumerate}
Durante la registrazione del tracciamento del muovimento dell'utente:
\begin{enumerate}
...
%da R1FC3 a R1FI8
TSF-X & Disponbilità organizzazioni visualizzabili dall'amministratore & \begin{itemize}
    \item Verificare che l'amministratore possa visualizzare le organizzazioni disponibli.
\end{itemize}
Se l'organizzazione visualizzata è disponbile:
\begin{enumerate}
