...
% R1FA2
TSF-X & Logout\ab{G} dell'utente & \begin{itemize}
    \item Verifica che l'utente possa effettuare il logout\ab{G} dall'applicazione.
\end{itemize} \\

%da R2FA6.1 a R2FA6.9
TSF-X & tracciamento\ab{G} dell'utente nell'organizzazione\ab{G} & \begin{enumerate}
    \item Verificare che il tracciamento\ab{G} del movimento\ab{G} dell'utente venga registrato correttamente.
    \item Verificare che l'utente abbia ricevuto la notifica della corretta registrazione del suo movimento\ab{G}.
    \item Verificare che se le informazioni necessarie per la registrazione del movimento\ab{G} non sono memorizzate, allora l'utente dovrà ricevere una notifica di tracciatura fallita.
\end{enumerate}
Durante la registrazione del tracciamento\ab{G} del movimento\ab{G} dell'utente:
\begin{enumerate}
...
\end{enumerate}
Se l'utente è in modalità di tracciamento\ab{G} autenticata:
\begin{enumerate}
    \item Verificare che abbia effettuato un ingresso nell'organizzazione\ab{G}.
    \item Verificare che abbia effettuato l'uscita nell'organizzazione\ab{G}.
\end{enumerate}
Se l'utente è in modalità di tracciamento\ab{G} anonima:
\begin{enumerate}
    \item Verificare che abbia effettuato un ingresso nell'organizzazione\ab{G}.
    \item Verificare che abbia effettuato l'uscita nell'organizzazione\ab{G}.
\end{enumerate} \\
...
\end{itemize}
Se l'organizzazione\ab{G} visualizzata è disponibile:
\begin{enumerate}
...
TSF-X & Monitoraggio dell'amministratore vedendo gli utenti presenti nell'organizzazione\ab{G} & \begin{itemize}
    \item Verificare che l'amministratore possa monitorare gli utenti presenti nell'organizzazione\ab{G}.
\end{itemize}
Se gli utenti monitorati presso l'organizzazione\ab{G} sono anonimi:
\begin{enumerate}
...
\end{enumerate}
Se gli utenti monitorati presso l'organizzazione\ab{G} sono riconosciuti:
\begin{enumerate}
    ...
    \item Verificare che l'amministratore possa filtrare la lista\ab{G} degli accessi di uno specifico utente riconosciuto per data decrescente.
    \item Verificare che l'amministratore possa filtrare la lista\ab{G} degli accessi di uno specifico utente riconosciuto per data crescente.
    \item Verificare che l'amministratore possa filtrare la lista\ab{G} degli accessi di uno specifico utente riconosciuto per una data precisa.
...
TSF-X & Selezione della modalità di tracciamento\ab{G} & \begin{enumerate}
    \item Verificare che l'utente possa inserire la modalità di tracciamento\ab{G}mento anonima.
    \item Verificare che l'utente possa inserire la modalità di tracciamento\ab{G} autenticata.
\end{enumerate}
Se l'utente si trova presso un luogo di un'organizzazione\ab{G}:
\begin{enumerate}
    \item Verificare che nel passaggio dalla modalità di tracciamento\ab{G} autenticato a quella anonima venga inviata al sistema la richiesta di uscita dell'utente dal luogo e la successiva richiesta di ingresso di utente anonimo.
    \item Verificare che nel passaggio dalla modalità di tracciamento\ab{G} anonima a quella autenticata venga inviata al sistema la richiesta di uscita dell'utente dal luogo e la successiva richiesta di ingresso di utente riconosciuto.
\end{enumerate} \\

% da R2FA5.1 a R2FA5.5, da R2FA5.10 a R2FA5.12, R2FA5.16, R2FA8.5
TSF-X & Storico degli accessi dell'utente presso un'organizzazione\ab{G} & \begin{enumerate}
    \item Verificare che l'utente possa vedere il proprio storico accessi presso un'organizzazione\ab{G}. Ogni accesso deve mostrare la data in cui è stato compiuto, il luogo corrispondente, il tempo totale trascorso all'interno nel luogo.
    \item Come al punto 1, ma la lista\ab{G} degli accessi deve risultare ordinata per data in ordine decrescente\ap{G}.
    \item Come al punto 1, ma la lista\ab{G} degli accessi deve risultare ordinata per data in ordine crescente\ap{G}.
    \item Come al punto 1, ma della lista\ab{G} vengono mostrati solo gli accessi che rispettano i parametri di ricerca sul giorno cercato.
    \item Verificare che in assenza di accessi effettuati presso un'organizzazione\ab{G} l'utente visualizzi un messaggio informativo.
\end{enumerate}
Se l'utente si trova presso un luogo di un'organizzazione\ab{G}:
\begin{enumerate}
    \item Verificare che l'utente possa visualizzare il tempo trascorso all'interno di tutti i luoghi dell'organizzazione\ab{G} dall'ultimo ingresso preceduto da un'uscita da un luogo di un'altra organizzazione\ab{G} se avvenuto nella stessa giornata o dall'inizio della giornata se quest'uscita è di un giorno precedente. % NON SONO SICURO, MOLTO COMPLESSO E FORSE NON FATTIBILE
\end{enumerate}
Se l'utente si trova presso un luogo di un'organizzazione\ab{G} e sta visualizzando lo storico accessi presso la stesso luogo:
\begin{enumerate}
...
TSF-X & Storico degli accessi dell'utente presso un luogo di un'organizzazione\ab{G} & \begin{enumerate}
    \item Verificare che l'utente possa vedere il proprio storico accessi presso il luogo di un'organizzazione\ab{G}. Ogni accesso deve mostrare la data in cui è stato compiuto, il luogo corrispondente, il tempo totale trascorso all'interno nel luogo.
    \item Come al punto 1, ma la lista\ab{G} degli accessi deve risultare ordinata per data in ordine decrescente\ap{G}.
    \item Come al punto 1, ma la lista\ab{G} degli accessi deve risultare ordinata per data in ordine crescente\ap{G}.
    \item Come al punto 1, ma della lista\ab{G} vengono mostrati solo gli accessi che rispettano i parametri di ricerca sul giorno cercato.
    \item Verificare che in assenza di accessi effettuati presso il luogo di un'organizzazione\ab{G} selezionato l'utente visualizzi un messaggio informativo.
\end{enumerate}
...
% R1FS2.1
TSF-X & Logout\ab{G} dell'amministratore & \begin{enumerate}
    \item Verifica che l'amministratore possa effettuare il logout\ab{G} dal server.
\end{enumerate} \\

% da R1FS5.1 a R1FS5.5
TSF-X & Modifica della lista dei luoghi di tracciamento\ab{G} di un'organizzazione\ab{G} & \begin{enumerate}
    \item Verificare che l'amministratore possa essere in grado di aggiungere un nuovo luogo in cui effettuare il tracciamento\ab{G}.
    \item Verificare che l'amministratore possa essere in grado di modificare un luogo dell'organizzazione\ab{G}.
    \item Verificare che l'amministratore possa essere in grado di eliminare un luogo dell'organizzazione\ab{G}.
    \item Verificare che venga negata la selezione di un'area che non rispetta i vincoli imposti per l'organizzazione\ab{G}, visualizzando un messaggio d'errore.
    \item Verificare che venga negato l'inserimento di un luogo se viene selezionata un'area che fuoriesce dal perimetro imposto per l'organizzazione\ab{G}, visualizzando un messaggio d'errore.
\end{enumerate} \\

% da R1FS5.5 a R1FS5.8
TSF-X & Modifica di un luogo di un'organizzazione\ab{G} & \begin{enumerate}
    \item Verificare che l'amministratore possa selezionare l'area geografica in cui effettuare il tracciamento\ab{G} mediante l'inserimento di coordinate geografiche.
    \item Verificare che l'amministratore possa selezionare l'area geografica in cui effettuare il tracciamento\ab{G} mediante l'inserimento di marcatori su una mappa interattiva.
    \item Verificare che l'amministratore possa annullare l'operazione di modifica del luogo dell'organizzazione\ab{G}.
\end{enumerate} \\
...
TSF-X & Nomina di un nuovo amministratore da parte di un altro amministratore per la stessa organizzazione\ab{G} & \begin{enumerate}
