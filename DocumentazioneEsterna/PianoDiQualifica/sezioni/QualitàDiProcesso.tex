...
\subsubsection{Garanzia di qualità}
    ...
    \begin{itemize}
        ...
        \item \textbf{Descrizione:} Viene indicato se il processo rispetta gli effetti e i risultati voluti. Un processo deve essere efficace\ap{G} al 100\% per garantire la sua qualità.
        \item \textbf{Processo di riferimento:} Processi supporto
        \item \textbf{Sigla:} EP
        \item \textbf{Range di valori che può assumere:} accettabile = 100\%, ottimale = 100\%
    \end{itemize}
