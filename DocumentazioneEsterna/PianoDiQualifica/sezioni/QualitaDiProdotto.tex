...
\paragraph{Metrica MPD2 - Validità dei Dati d'Input} 
\begin{itemize}
...
\paragraph{Metrica MPD3 - Attrattività della User Interface (UI)} 
\begin{itemize}
...
\paragraph{Metrica MPD4 - Complessità Ciclomatica del Software} 
    \begin{itemize}
...
\paragraph{Metrica MPD5 - Unità Documentate} 
\begin{itemize}
...
\paragraph{Metrica MPD6 - Maturità dei Test} 
\begin{itemize}
...
\paragraph{Metrica MPD7 - Profondità Strutturale dell'Interfaccia}
\begin{itemize}
...
\endhead
    ...
    MPD2 & Validità dei Dati d'Input & $VDI$ &  $VDI \geq 90\%$ &  $VDI = 100\%$\\
    MPD3 & Attrattività della User Interface (UI) & $AUI$ & $AUI = Attrattivo$ &  $AUI = Molto \; attrattivo$\\
    MPD4 & Complessità Ciclomatica del Software & $CCS $ & $1 \leq CCS \leq 7 $ & $1 \leq CCS \leq 4$\\
    MPD5 & Unità Documentate & $UD$ & $UD \geq 90\%$ & $UD = 100\%$\\
\end{longtable} 
\newpage
\rowcolors{2}{grigetto}{white}
\renewcommand{\arraystretch}{1.5}
...
\rowcolor{darkblue}
\textcolor{white}{\textbf{Metrica}} & \textcolor{white}{\textbf{Nome}} & \textcolor{white}{\textbf{Sigla}} & \textcolor{white}{\textbf{Range Accettabile}} & \textcolor{white}{\textbf{Range Ottimale}}\\
    MPD6 & Maturità dei Test & $MT$ & $MT = 100\%$ & $MT = 100\%$\\
    MPD7 & Profondità Strutturale dell'Interfaccia & $PSI$ & $1 \leq PSI \leq 5$ &$1 \leq PSI \leq 3$\\
\end{longtable}
