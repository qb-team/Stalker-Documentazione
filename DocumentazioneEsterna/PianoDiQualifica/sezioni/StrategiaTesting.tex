...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{F}: il requisito di riferimento è funzionale\ap{G};
        \item \textbf{Q}: il requisito di riferimento è qualitativo\ap{G};
        \item \textbf{P}: il requisito di riferimento è prestazionale\ap{G};
        \item \textbf{V}: il requisito di riferimento è un vincolo\ap{G};
    \end{itemize}
