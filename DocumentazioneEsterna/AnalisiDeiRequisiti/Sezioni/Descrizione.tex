...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Venire tracciati nelle \glo{organizzazioni} desiderate}: ;
        \item \textbf{Gestione delle \glo{organizzazioni} preferite}: ;
        \item \textbf{Visualizzare gli accessi effettuati presso le varie \glo{organizzazioni} e i relativi luoghi}: ;
        \item \textbf{Passare in tracciabilità anonima e non presso \glo{organizzazioni} private}: .
    \end{itemize}
\end{itemize}
