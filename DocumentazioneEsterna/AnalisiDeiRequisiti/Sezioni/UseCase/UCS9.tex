...
\subsubsection{UCS 9.5 - Nomina di un nuovo amministratore già presente nel server LDAP}%sea level
\begin{itemize}
\item \textbf{Attori primari:} Amministratore proprietario
%\item \textbf{Attori secondari:}%opzionale
\item \textbf{Precondizione:} L'amministratore è autenticato presso il sistema e si trova nella funzionalità di gestione degli amministratori.
\item \textbf{Postcondizione:} L'amministratore ha nominato un account già presente nel server LDAP come amministratore della propria organizzazione.
