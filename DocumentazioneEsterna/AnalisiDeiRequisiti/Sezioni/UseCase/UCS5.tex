...
\begin{figure}[h]
	\centering
    \includegraphics[scale=0.40]{Sezioni/UseCase/Immagini/UCS5(Corretto).png}
...
\begin{itemize}
    \item \textbf{Attori primari:} Amministratore gestore
    \item \textbf{Precondizione:} L'amministratore si trova nella selezione dell’area geografica per il tracciamento dell'\glo{organizzazione} [UCS 5.5].
...
%\item \textbf{Inclusioni:}
 %   \begin{enumerate}
  %      \item UCS 5.5.1 - Selezione dell'area di \glo{tracciamento}tramite inserimento delle coordinate geografiche;
   %     \item UCS 5.5.2 - Selezione dell'area di \glo{tracciamento}tramite Google Maps API.
    %\end{enumerate}
\item \textbf{Estensioni:}
\begin{enumerate}
...
\item \textbf{Flusso di eventi:}
\begin{enumerate}
    \item L'amministratore inserisce le coordinate del primo vertice dell'area di \glo{tracciamento};
    \item L'amministratore inserisce le coordinate del secondo vertice dell'area di \glo{tracciamento};
    \item L'amministratore inserisce le coordinate del terzo vertice dell'area di \glo{tracciamento};
    \item L'amministratore inserisce le coordinate del quarto vertice dell'area di \glo{tracciamento}.
\end{enumerate}
\end{itemize}
