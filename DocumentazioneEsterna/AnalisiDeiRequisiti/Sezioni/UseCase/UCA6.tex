...
\begin{itemize}
	...
	\item \textbf{Precondizione:} L'utente autenticato sta per effettuare un \glo{movimento} in un'\glo{organizzazione} o in un luogo all'interno di essa.
	\item \textbf{Postcondizione:} L'utente ha effettuato un \glo{movimento} presso l'\glo{organizzazione} o in un all'interno di essa e ne viene notificato. %e vengono salvate alcune cose? 
	\item \textbf{Scenario principale:} L'utente si trova nei pressi di un'\glo{organizzazione} o un suo luogo e sta per effettuare un \glo{movimento}. L'utente riceve una notifica una volta effettuato il movimento. %Viene salvato l'orario di entrata ed uscita dall'\glo{organizzazione} e il tempo trascorso all'interno dell'\glo{organizzazione}. L'utente riceve inoltre una notifica per l'entrata e l'uscita dall'\glo{organizzazione}.
\end{itemize}
...
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo, Utente riconosciuto
	\item \textbf{Attori secondari:} Servizi/o di localizzazione (\glo{GPS}, rete cellulare), server \glo{LDAP} dell'\glo{organizzazione}.
	\item \textbf{Precondizione:} L'utente autenticato sta per effettuare un \glo{movimento} in un'\glo{organizzazione}.
	\item \textbf{Postcondizione:} L'utente ha effettuato un \glo{movimento} presso l'\glo{organizzazione} e ne viene notificato.
	\item \textbf{Scenario principale:} L'utente si trova nei pressi di un'\glo{organizzazione} e sta per effettuare un \glo{movimento}. L'utente riceve una notifica una volta effettuato il movimento.
...
\begin{itemize}
	...
	\item \textbf{Scenario principale:} L'utente una volta effettuato il movimento ne riceve una notifica.	
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Postcondizione:} L'utente ha effettuato un \glo{movimento} presso un luogo all'interno di un'\glo{organizzazione} e ne viene notificato.
