...
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo
	\item \textbf{Precondizione:} L'utente sta visualizzando un accesso ad un'\glo{organizzazione}.
...
\begin{itemize}
    ...
    \item \textbf{Flusso di eventi:}
    \begin{enumerate}
        \item L'utente seleziona la funzionalità per mostrare gli accessi effettuati presso un luogo dell'\glo{organizzazione} precedentemente selezionata;
        \item L'utente visiona per ogni accesso le sue informazioni.
    \end{enumerate}
    \item \textbf{Estensioni:}
    \begin{itemize}
...
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo
	\item \textbf{Precondizione:} L'utente sta visualizzando un accesso ad un luogo dell'\glo{organizzazione}.
	\item \textbf{Postcondizione:} L'utente visiona le informazioni relative all'accesso effettuato.
...
\begin{itemize}
    ...
    \item \textbf{Flusso di eventi:}
    \begin{enumerate}
        \item L'utente seleziona la funzionalità per riordinare lo \glo{storico degli accessi} \glo{per data in un determinato ordine}.
    \end{enumerate}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Flusso di eventi:}
	\begin{enumerate}
		\item L'utente seleziona la funzionalità per riordinare lo \glo{storico degli accessi} \glo{per data in ordine decrescente}.
	\end{enumerate}   
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Flusso di eventi:}
    \begin{enumerate}
        \item L'utente seleziona la funzionalità per riordinare lo \glo{storico degli accessi} \glo{per data in ordine crescente}.
    \end{enumerate}
\end{itemize}
