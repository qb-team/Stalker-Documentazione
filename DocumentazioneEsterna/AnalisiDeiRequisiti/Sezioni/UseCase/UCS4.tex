...
\begin{itemize}
	...
	\item \textbf{Postcondizione:} L'amministratore ha modificato i parametri desiderati dell'\glo{organizzazione} o eliminato l'\glo{organizzazione}. Le modifiche sono state salvate nel sistema.
	\item \textbf{Scenario principale:} L'amministratore deve scegliere l'\glo{organizzazione} che vuole modificare, selezionare la funzionalità di modifica o eliminazione dell'\glo{organizzazione} e quindi procedere con il cambiamento dei parametri.
