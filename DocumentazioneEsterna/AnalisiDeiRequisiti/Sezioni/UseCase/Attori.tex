...
Utente autenticato che può venire tracciato all'interno di una organizzazione\ap{G} senza fornire dettagli sulla propria identità.
\paragraph{Utente riconosciuto}
Utente autenticato che è attualmente tracciato all'interno di una precisa organizzazione\ap{G} fornendo dettagli sulla propria identità.
L'utente si è precedentemente autenticato presso l'organizzazione\ap{G} tramite LDAP.
...
Amministratore autenticatosi con il ruolo di proprietario dell'organizzazione\ap{G}.
Si trova al gradino più alto della gerarchia degli amministratori e dispone delle seguenti funzioni:
\begin{itemize}
\item Gestire l'organizzazione\ap{G}, ovvero modificarne i dati (come nome, descrizione, ecc.) e le superfici geografiche per il tracciamento\ap{G}degli utenti
\item Gestire gli amministratori, cioè la loro nomina, rimozione e modifica dei privilegi
\item Monitorare gli accessi
\item Eliminare l'organizzazione\ap{G}
\end{itemize}
Il proprietario dell'organizzazione\ap{G} può nominare altri amministratori.
...
\begin{itemize}
\item Gestire l'organizzazione\ap{G}
\item Monitorare gli accessi
\end{itemize}
