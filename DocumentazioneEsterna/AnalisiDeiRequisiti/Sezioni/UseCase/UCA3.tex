...
\begin{itemize} 
	...
	\item \textbf{Flusso di eventi:}
	\begin{enumerate}
		\item L'utente accede alla funzionalità di aggiornamento della lista delle \glo{organizzazioni};
		\item L'utente ha la possibilità di effettuare l'aggiornamento lista \glo{organizzazione} con \glo{refresh manuale} [UCA 3.3.1];
		\item L'utente ha la possibilità di effettuare l'aggiornamento lista \glo{organizzazione} con \glo{temporizzazione} [UCA 3.3.2].
	\end{enumerate}
...
\begin{itemize}
	...
	\item \textbf{Flusso di eventi:}
	\begin{enumerate}
		\item L'utente esegue l'aggiornamento della lista delle \glo{organizzazioni} attraverso un \glo{refresh manuale}.
	\end{enumerate}
...
\begin{itemize} 
	...
	\item \textbf{Flusso di eventi:}
	\begin{enumerate}
		\item L'utente esegue l'aggiornamento della lista dell'\glo{organizzazione} attraverso la modalità \glo{temporizzazione}.
	\end{enumerate}
\end{itemize}
...
\begin{itemize} 
	...
	\item \textbf{Flusso di eventi:}
	\begin{enumerate}
		\item L'utente esegue la funzione per la visualizzazione della lista, visualizzando i nomi delle \glo{organizzazioni} presenti;
		\item L'utente ha la possibilità di ordinare le \glo{organizzazioni} alfabeticamente [UCA 3.4.1];
		\item L'utente ha la possibilità di ordinare le \glo{organizzazioni} secondo la politica \glo{FIFO} [UCA 3.4.2];
		\item L'utente ha la possibilità di applicare un filtro per modalità di tracciamento anonimo [UCA 3.4.3];
		\item L'utente ha la possibilità di applicare un filtro per modalità di \glo{tracciamento autenticato} [UCA 3.4.4].
	\end{enumerate}
...
\begin{itemize}
	...
	\item \textbf{Flusso di eventi:}
	\begin{enumerate}
		\item L'utente esegue la funzione per la visualizzazione della lista, visualizzando i nomi delle \glo{organizzazioni} presenti in ordine alfabetico.
	\end{enumerate}
\end{itemize}
...
\begin{itemize}	
	...
	\item \textbf{Flusso di eventi:}
		\begin{enumerate}
		\item L'utente esegue la funzione per la visualizzazione della lista, visualizzando i nomi delle \glo{organizzazioni} presenti secondo un ordinamento \glo{FIFO}.
	\end{enumerate}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Flusso di eventi:}
		\begin{enumerate}
		\item L'utente esegue la funzione per la visualizzazione della lista, visualizzando i nomi delle \glo{organizzazioni} che permettono il \glo{tracciamento anonimo}.
	\end{enumerate}
\end{itemize}

\subsubsection{UCA 3.4.4 - Visualizzazione con filtro per \glo{tracciamento autenticato}}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo
	...
	\item \textbf{Flusso di eventi:}
	\begin{enumerate}
		\item L'utente esegue la funzione per la visualizzazione della lista, visualizzando i nomi delle \glo{organizzazioni} che permettono il \glo{tracciamento autenticato}.
	\end{enumerate}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Flusso di eventi:}
	\begin{enumerate}
		\item L'utente esegue la funzione di ricerca personalizzata della lista delle \glo{organizzazioni} per ricercare le \glo{organizzazioni} desiderate, filtrando per la nazione scelta.
	\end{enumerate}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Flusso di eventi:}
	\begin{enumerate}
		\item L'utente esegue la funzione di ricerca personalizzata della lista delle \glo{organizzazioni} per ricercare le \glo{organizzazioni} desiderate, filtrando per il nome della \glo{organizzazione} scelta.
	\end{enumerate}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Flusso di eventi:}
	\begin{enumerate}
		\item L'utente esegue la funzione di ricerca personalizzata della lista delle \glo{organizzazioni} per ricercare le \glo{organizzazioni} desiderate, filtrando per la città scelta.
	\end{enumerate}
\end{itemize}