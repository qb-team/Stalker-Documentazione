...
\begin{itemize}
	...
	\item \textbf{Flusso di eventi:}
			...
			\item Vi è la possibilità di inserire un'\glo{organizzazione} nella lista delle \glo{organizzazioni preferite} dell'utente dell'applicazione [UCA 3.2.1], opppure di inserire nella lista dei preferiti una \glo{organizzazione} che richiede di autenticarsi con credenziali \glo{LDAP} [UCA 3.2.2];
...
\subsubsection{UCA 3.5.5 - Visualizzazione con filtro per tracciamento autenticato}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo
