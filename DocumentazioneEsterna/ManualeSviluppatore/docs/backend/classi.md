...
- `unbindAdministratorFromOrganization`: cancella i permessi di un amministratore da un'organizzazione passando al metodo un oggetto **Permission**; utilizza il metodo `deleteById` della classe **PermissionRepository**.  
___
