...
\begin{itemize}
    ...
    \begin{enumerate}%flusso di eventi
        ...
        \item UCS 5.5: L'amministratore seleziona un'area geografica da associare al perimetro\ap{G} di tracciamento dell'organizzazione. L'area selezionata deve rispettare i vincoli imposti;
    \end{enumerate}
