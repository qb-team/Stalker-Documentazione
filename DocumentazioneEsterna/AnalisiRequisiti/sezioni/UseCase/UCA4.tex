...
\subsubsection{UCA 4.1 - Inserimento modalità di tracciamento anonimo\ap{G}}%sea level
\begin{itemize}
	\item \textbf{Attori primari:} Utente riconosciuto
...
\subsubsection{UCA 4.2 - Inserimento modalità di tracciamento\ap{G}autenticato}%sea level
\begin{itemize}
	\item \textbf{Attori primari:} Utente riconosciuto
	...
	\end{enumerate}
	\begin{itemize}
		\item UCA 6.4 - Tracciamento\ap{G}anonimo della posizione durante l'uscita da un luogo di un'organizzazione\ap{G};
		\item UCA 6.1 - Tracciamento\ap{G}autenticato della posizione durante l'ingresso in un luogo di un'organizzazione\ap{G}.
	\end{itemize}
\end{itemize}
