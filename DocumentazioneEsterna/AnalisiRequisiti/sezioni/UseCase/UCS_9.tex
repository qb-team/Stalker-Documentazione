\subsubsection{Panoramica UCS 9}%sea level
\begin{figure}[h]
  \centering
...
\item \textbf{Postcondizione:} L'amministratore ha eseguito l'azione desiderata tra: creazione di un amministratore [UCS 9.1], eliminazione di un amministratore [UCS 9.2] e modifica dei privilegi di un amministratore [UCS 9.3].
\item \textbf{Scenario alternativo:} L'amministratore seleziona la funzionalità per annullare le modifiche agli amministatori [UCS 9.4].
\item \textbf{Flusso di eventi:} %elenco puntato
  \begin{enumerate}
        ...
        \item L'amministratore seleziona una funzionalità tra: creazione di un amministratore [UCS 9.1], eliminazione di un amministratore [UCS 9.2] e modifica dei privilegi di un amministratore [UCS 9.3].
    \end{enumerate}
...
\subsubsection{UCS 9.1 - Creazione di un nuovo amministratore}%sea level
\begin{figure}[h]
  \centering
    \includegraphics[scale=0.5]{sezioni/UseCase/Immagini/UCS9.1.png}
  \caption{UCS 9.1 - Creazione di un nuovo amministratore}
\end{figure}
...
\item \textbf{Scenario principale:} L'amministratore compila il modulo per la creazione del nuovo amministratore.
\item \textbf{Flusso di eventi:} %elenco puntato
  \begin{enumerate}
        ...
        \item Selezione dei privilegi del nuovo amministratore [UCS 9.1.4]. Si drovrà scegliere tra "Visualizzatore" e "Gestore".
    \end{enumerate}
\item \textbf{Estensioni:}
	\begin{itemize}
