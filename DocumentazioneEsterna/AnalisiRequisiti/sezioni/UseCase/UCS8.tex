...
\subsubsection{UCS 8.1.3 - Tabella contenente per ogni luogo tracciato appartenente all'azienda il totale delle ore che tutti i dipendnenti vi hanno passato e il numero di dipendenti che li hanno frequentati.}%fish level
\begin{itemize}
\item \textbf{Attori primari:} Amministratore autenticato\ap{G};
\item \textbf{Precondizione:} L'amministratore seleziona questa opzione per la generazione della tabella;
\item \textbf{Postcondizione:} La tabella richiesta è corretta e l'amministratore può visionarla.
