...
\newpage
\subsubsection{Panoramica della gestione di un'organizzazione\ap{G}}%kite level
...
\begin{figure}[h]
	\centering
    \includegraphics[scale=0.53]{sezioni/UseCase/Immagini/Panoramica gestione organizzazione\ap{G}.png}
