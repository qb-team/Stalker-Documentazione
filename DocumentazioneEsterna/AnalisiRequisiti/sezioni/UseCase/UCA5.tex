...
\begin{figure}[h]
	\centering
	\caption{UCA 5 - Gestione lista delle organizzazioni}
	\includegraphics[scale=0.33]{sezioni/UseCase/Immagini/UCA5.png}
\end{figure}
\section{UCA 5 - Gestione lista delle organizzazioni}%kite level
\begin{itemize}
...
\subsection{UCA 5.1 - Scaricamento lista di tutte le organizzazioni}%sea level
\begin{itemize}
\item \textbf{Attori primari:} Utente anonimo;
\item \textbf{Attori secondari: } Server di Stalker;
...
\item \textbf{Estensioni:}
	\begin{enumerate}
	\item UCA 5.1.1 Visualizzazione di un messaggio di errore che informa la non disponibilità del server.
\end{enumerate}
  
\end{itemize}

\subsubsection{UCA 5.1.1 - Visualizzazione di un messaggio di errore che informa la non disponibilità del server}%fish level
\begin{itemize}
\item \textbf{Attori primari:} Utente anonimo;
...
\begin{figure}[h]
	\centering
	\caption{UCA 5.2 - Gestione lista dei preferiti}
	\includegraphics[scale=0.5]{sezioni/UseCase/Immagini/UCA5.2.png}
\end{figure}
\subsection{UCA 5.2 - Gestione lista dei preferiti}%sea level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo;
	...
	\item \textbf{Scenario principale:}
			...
			\item L'utente puo selezionare la funzione UCA 5.2.1 Inserimento di una organizzazione nella lista dei preferiti dell’utente dell’applicazione;
			\item L'utente puo selezionare la funzione UCA 5.2.2 Rimozione di una organizzazione dalla lista dei preferiti dell’utente dell’applicazione.
			\end{itemize}
	...
	\item \textbf{Estensioni:}
	\begin{enumerate}
		\item UCA 5.1.2 Visualizzazione di un messaggio di errore che informa che non è salvata nessuna lista delle organizzazioni.
	\end{enumerate}
\end{itemize}

\subsubsection{UCA 5.2.1 - Inserimento di una organizzazione nella lista dei preferiti dell’utente dell’applicazione}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo;
...
\subsubsection{UCA 5.2.2 - Rimozione di una organizzazione dalla lista dei preferiti dell’utente dell’applicazione}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo;
...
\begin{figure}[h]
	\centering
	\caption{UCA 5.3 - Aggiornare lista organizzazione}
	\includegraphics[scale=0.5]{sezioni/UseCase/Immagini/UCA5.3.png}
\end{figure}
\subsection{UCA 5.3 - Aggiornare lista organizzazione}%sea level
\begin{itemize} 
	\item \textbf{Attori primari:} Utente anonimo;
	\item \textbf{Attori secondari:} Server di Stalker;
	...
	\begin{itemize}
		\item UCA 5.3.1 Aggiornamento lista organizzazione con refresh manuale;
		\item UCA 5.2.2 Aggiornamento lista organizzazione con temporizzazione.
	\end{itemize}
	...
	\item \textbf{Estensioni:}
	\begin{enumerate}
		\item UCA 5.3.3 Visualizzazione di un messaggio che informa la non disponibilità del server.
	\end{enumerate}
\end{itemize}

\subsubsection{UCA 5.3.1 - Aggiornare lista organizzazione con refresh manuale}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo;
	\item \textbf{Attori secondari:} Server di Stalker;
...
\subsubsection{UCA 5.3.2 - Aggiornare lista organizzazione con temporizzazione}%fish level
\begin{itemize} 
	\item \textbf{Attori primari:} Utente anonimo;
	\item \textbf{Attori secondari:} Server di Stalker;
...
\subsubsection{UCA 5.3.3 - Visualizzazione di un messaggio di errore che informa che non è salvata nessuna lista delle organizzazioni}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo;
...
\begin{figure}[h]
	\centering
	\caption{UCA 5.4 - Visualizzazione lista}
	\includegraphics[scale=0.5]{sezioni/UseCase/Immagini/UCA5.4.png}
\end{figure}
\subsection{UCA 5.4 - Visualizzazione lista}%sea level
\begin{itemize} 
	\item \textbf{Attori primari:} Utente anonimo;
	...
	\begin{itemize}
		...
		\item L'utente puo selezionare la modalità UCA 5.4.1 Ordinamento automatico (FIFO\ap{G});
		\item L'utente puo selezionare la modalità UCA 5.4.2 Ordinamento alfabetico;
		\item L'utente puo selezionare la modalità UCA 5.4.3 Filtro per tracciamento anonima;
		\item L'utente puo selezionare la modalità UCA 5.4.4 Filtro per tracciamento autenticato.
	\end{itemize}
	\item \textbf{Scenario alternativo:} Se non è presente nessuna lista delle organizzazioni viene visualizzato all’utente un messaggio di errore che lo informa di tale problema;
	\item \textbf{Estensioni:}
	\begin{enumerate}
...
\subsubsection{UCA 5.4.1 - Ordinamento}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo;
	...
	\begin{enumerate}
		\item UCA 5.4.2 Ordinamento automatico FIFO \ap{G};
		\item UCA 5.4.3 Ordinamento alfabetico.
	\end{enumerate}
\end{itemize}

\subsubsection{UCA 5.4.2 - Ordinamento alfabetico}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo;
...
\subsubsection{UCA 5.4.3 - Ordinamento automatico FIFO}%fish level
\begin{itemize}	
	\item \textbf{Attori primari:} Utente anonimo;
...
\subsubsection{UCA 5.4.4 - Filtro per tracciamento}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo;
	\item \textbf{Precondizione:} L’utente autenticato può utilizzare la funzionalità di visualizzazione della lista secondo un ordinamento automatico;
	\item \textbf{Postcondizione:} Viene visualizzato il risultato richiesto dall’utente anonimo;
	\begin{enumerate}
		\item UCA 5.4.5 Filtro per tracciamento anonimo;
		\item UCA 5.4.6 Filtro per tracciamento autenticato.
	\end{enumerate}
\end{itemize}

\subsubsection{UCA 5.4.5 - Filtro per tracciamento anonimo}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo;
...
\subsubsection{UCA 5.4.6 - Filtro per tracciamento autenticato}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo;
...
\begin{figure}[h]
	\centering
	\caption{UCA 5.5 - Ricerca personalizzata delle organizzazioni}
	\includegraphics[scale=0.5]{sezioni/UseCase/Immagini/UCA5.5.png}
\end{figure}
\subsection{UCA 5.5 - Ricerca personalizzata delle organizzazioni}%sea level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo;
	...
	\begin{itemize}
		...
		\item L'utente puo selezionare la modalità di ricerca UCA 5.5.1 Ricerca per nazione;
		\item L'utente puo selezionare la modalità di ricerca UCA 5.5.2 Ricerca per nome;
		\item L'utente puo selezionare la modalità di ricerca UCA 5.5.3 Ricerca per città.
	\end{itemize}
	\item \textbf{Scenario alternativo:} Se non è presente nessuna lista delle organizzazioni viene visualizzato all’utente un messaggio di errore che lo informa di tale problema;
	\item \textbf{Estensioni:}
	\begin{enumerate}
...
\subsubsection{UCA 5.5.1 - Ricerca per nazione}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo;
...
\subsubsection{UCA 5.5.2 - Ricerca per nome}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo;
...
\subsubsection{UCA 5.5.3 - Ricerca per città}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo;
