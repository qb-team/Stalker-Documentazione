...
\begin{itemize}
    ...
    \item \textbf{Postcondizione:} L'utente ha visualizzato lo storico degli accessi relativo all'organizzazione\ap{G} desiderata oppure al luogo desiderato dell'organizzazione\ap{G} scelta.
    \item \textbf{Scenario principale:} L'utente selezionerà l'organizzazione\ap{G} desiderata dalla lista delle organizzazioni\ap{G} e quindi la funzionalità per mostrare lo storico degli accessi oppure un luogo specifico per analizzarne il relativo storico degli accessi.
\end{itemize}
