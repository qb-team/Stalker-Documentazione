\subsubsection{Panoramica UCA 7}%kite level
\begin{figure}[h]
	\centering
...
\begin{itemize}
	...
	\item \textbf{Scenario principale:} L'utente autenticato come utente anonimo effettua l'autenticazione con credenziali LDAP\ap{G} [UCA 7.1] per autenticarsi come utente riconosciuto all'interno della relativa organizzazione.
\end{itemize}
