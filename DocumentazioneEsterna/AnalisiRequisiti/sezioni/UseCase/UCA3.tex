...
\subsubsection{UCA 3 - Gestione lista delle organizzazioni\ap{G}}%kite level
\begin{figure}[h]
	\centering
...
\subsubsection{UCA 3.1 - Scaricamento lista di tutte le organizzazioni\ap{G}}%sea level
\begin{itemize}
\item \textbf{Attori primari:} Utente anonimo
...
\subsubsection{UCA 3.2 - Gestione lista delle organizzazioni\ap{G} preferite}%sea level
\begin{figure}[h]
	\centering
...
\subsubsection{UCA 3.2.1 - Inserimento di una organizzazione\ap{G} nella lista delle organizzazioni\ap{G} preferite dell'utente}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo
...
\subsubsection{UCA 3.2.2 - Inserimento di una organizzazione\ap{G} che richiede credenziali LDAP nella lista delle organizzazioni\ap{G} preferite dell'utente}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo
	...
	\begin{itemize}
			\item UCA 7 - Autenticazione\ap{G} con credenziali LDAP.
	\end{itemize}
\end{itemize}

\subsubsection{UCA 3.2.3 - Rimozione di una organizzazione\ap{G} dalla lista delle organizzazioni\ap{G} preferite dell'utente}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo
...
\subsubsection{UCA 3.3 - Aggiornare lista organizzazioni\ap{G}}%sea level
...
\subsubsection{UCA 3.3.1 - Aggiornare lista organizzazione\ap{G} con refresh manuale}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo
...
\subsubsection{UCA 3.3.2 - Aggiornare lista organizzazione\ap{G} con temporizzazione}%fish level
\begin{itemize} 
	\item \textbf{Attori primari:} Utente anonimo
...
\subsubsection{UCA 3.4 - Visualizzazione lista delle organizzazioni\ap{G}}%sea level
...
\subsubsection{UCA 3.4.3 - Visualizzazione con filtro per tracciamento\ap{G}anonimo}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo
...
\subsubsection{UCA 3.4.4 - Visualizzazione con filtro per tracciamento\ap{G}autenticato}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo
...
\subsubsection{UCA 3.5 - Ricerca personalizzata delle organizzazioni\ap{G}}%sea level
\begin{figure}[h]
	\centering
