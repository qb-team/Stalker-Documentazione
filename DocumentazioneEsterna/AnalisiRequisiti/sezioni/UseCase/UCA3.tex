...
\begin{itemize}
	...
	\item \textbf{Flusso di eventi:}
			...
			\item Vi è la possibilità di inserire un'organizzazione\ap{G} nella lista delle organizzazioni preferite\ap{G} dell'utente dell'applicazione [UCA 3.2.1], se pero viene richiesto di inserire una organizzazione\ap{G} che richiede di autenticarsi con credenziali LDAP\ap{G} [UCA 3.2.2] allora l'utente dovrà inserire tali credenziali [UCA 1.1];
...
\subsubsection{UCA 3.5.1 - Ricerca con fitro per nazione}%fish level
\begin{itemize}
	\item \textbf{Attori primari:} Utente anonimo
