...
\begin{itemize}
	...
	\item \textbf{Flusso di eventi:}
	\begin{enumerate}
		\item L'utente seleziona l'organizzazione\ap{G} da inserire nella lista dei preferiti\ap{G};
		\item L'utente conferma l'inserimento nella lista dei preferiti\ap{G} per l'organizzazione\ap{G} scelta.
	\end{enumerate}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Flusso di eventi:}
	\begin{enumerate}
		\item L'utente seleziona l'organizzazione\ap{G} da rimuovere dalla lista dei preferiti\ap{G};
		\item L'utente conferma la rimozione dalla lista dei preferiti\ap{G} per l'organizzazione\ap{G} scelta.
	\end{enumerate}
\end{itemize}
