...
R1VC2.1 & Le comunicazioni di tracciamento\ap{G}tra applicazione cellulare e Server devono avvenire solo al momento d’ingresso ed uscita dai luoghi designati & \o & Capitolato \\
...
R2VC8.1 & Utilizzo di tecnologie network-GPS\ap{G} per il tracciamento\ap{G}della posizione & \d & Capitolato \\
R1VC8.2 & Si deve fornire un resoconto sulle scelte fatte e sui test effettuati relativi al tracciamento\ap{G}della posizione & \o & Capitolato \\
...
R1VC12.1 & Si deve utilizzare il protocollo LDAP per autenticare i singoli dipendenti e gli amministratori di una organizzazione\ap{G} per poter effettuare il tracciamento\ap{G}autenticato della posizione & \o & Capitolato \\	
...
R1VV1.2 & Le credenziali per accedere alla applicazione e le credenziali per accedere e autenticarsi in una organizzazione\ap{G} che richiede tracciamento\ap{G}autententicato devono essere diverse & \o & VE\_2019\_12\_16 \\
R1VV1.3 & I server LDAP delle organizzazioni\ap{G} che richiedono autenticazione\ap{G} devono essere esterni al sistema.  & \o & VE\_2019\_12\_16 \\
